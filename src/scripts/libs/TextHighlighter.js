(function (global) {
    ...
    TextHighlighter.prototype.removeHighlightsByClass = function (clsName) {
        var container = this.el,
            highlights = this.getHighlightsByClass({ container: container, clsName: clsName }),
            self = this;
    ...
    TextHighlighter.prototype.getHighlightsByClass = function (params) {
        params = defaults(params, {
            container: this.el,
            andSelf: true,
            grouped: false
        ...
        var nodeList = params.container.querySelectorAll('.' + params.clsName),
            highlights = Array.prototype.slice.call(nodeList);
